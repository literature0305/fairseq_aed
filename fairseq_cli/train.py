...
def train(
    ...
    # get generator for sequence level training
    if num_updates > cfg.optimization.num_update_start_sdt:
        cfg.generation.beam = cfg.optimization.beam_sdt
        cfg.generation.nbest = cfg.optimization.nbest_sdt
        generator = task.build_generator([trainer.get_model()], cfg.generation)
    else:
        generator = None
