...
class OptimizationConfig(FairseqDataclass):
    beam_sdt: int = field(
        default=1, metadata={"help": "beam size for sequence discriminative training"}
    )
    nbest_sdt: int = field(
        default=1, metadata={"help": "number of hypotheses for sequence discriminative training"}
    )
    max_epoch: int = field(
    ...
    num_update_start_sdt: int = field(
        default=999999999, metadata={"help": "force start sequence discriminative training at specified update"}
    )
